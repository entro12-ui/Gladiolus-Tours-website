...
export const CulturalActivities: ICulturalActivities[] = [
  {
    ...
    description:
      '\n' +
      '\n' +
      'Tanzanite, a rare and bewitching gemstone, is native to Tanzania, where it takes its name from. This deep, vibrant blue gem is renowned for its beauty and rarity. It is mined in the Merelani mines at the foot of Mount Kilimanjaro, adding a touch of adventure to the story.\n' +
      '\n' +
      'Tanzanite is prized for its unique color, which varies from blue-violet to intense violet, depending on the angle of view. It is often used in jewelry to create unique and dazzling pieces.\n' +
      '\n' +
      'This precious stone is also shrouded in mystery and legend. It is said to possess healing and protective powers, bringing mental clarity and emotional balance to the wearer.\n' +
      '\n' +
      'Tanzanite is a stone coveted by collectors and lovers of rare gems. Its rarity and beauty make it a true treasure of nature.\n' +
      '\n' +
      'If you’re curious to learn more about this rare and bewitching stone, a visit to the Tanzanite Museum in Arusha is a must.\n' +
      '\n' +
      'If you’re curious to learn more about this rare and bewitching stone, a visit to the Tanzanite Museum in Arusha is a must.\n' +
      '\n' +
  ...
  {
    id: 2,
    title: 'Walking safari in Arusha National Park',
    status: true,
    description:
  ...
  },
  {
    ...
    description:
      '\n' +
      '\n' +
      'A night safari in Tanzania is a thrilling experience that plunges you into the heart of Africa’s wildlife. As the sun sets and night falls, you climb into an all-terrain vehicle, ready to explore the mysteries of the savannah.\n' +
      '\n' +
      'In the dark, your senses sharpen and your excitement grows. You listen carefully to the sounds of nature, the roars of lions, the cries of hyenas and the calls of night birds. Your experienced guide uses his flashlight to illuminate the surroundings, revealing glowing eyes in the darkness.\n' +
      '\n' +
      'You’ll see animals you’d never see during the day. Leopards slither silently through the trees, elephants move majestically in the darkness and hippos emerge from the water to feed. It’s a real adventure in the kingdom of predators and nocturnal creatures.\n' +
      '\n' +
      'The magic happens when you look up at the twinkling stars in the African sky. The Milky Way shines intensely above you, creating a mystical, spellbinding atmosphere. You feel connected to nature and the universe in all its splendor.\n' +
      '\n' +
  ...
  {
    id: 4,
    title: 'Visit to the village of Mto wa Mbu',
    status: true,
    description:
  ...
  {
    id: 5,
    title: "Visit Arusha's souvenir market",
    status: true,
    description:
      'A visit to Arusha’s souvenir market is a must for travelers in search of unique and authentic souvenirs. From the moment you arrive, you’ll be greeted by a lively, colorful atmosphere, with stalls overflowing with local handicrafts.\n' +
  ...
  {
    id: 6,
    title: 'Visit to the Hadzabe tribe',
    status: true,
    description:
      '\n' +
      '\n' +
      'The Hadzabe tribe is a group of hunter-gatherers living in the Lake Eyasi region of northern Tanzania. They are considered one of Africa’s last hunter-gatherer tribes and have a unique way of life.\n' +
      '\n' +
      'The Hadzabe live mainly from hunting, gathering and fishing, using traditional techniques such as poisoned arrows and traps. Their knowledge of nature and wildlife is impressive, enabling them to follow animal tracks and find food in their environment.\n' +
      '\n' +
  ...
  {
    id: 7,
    title: 'Maasai village visit in Tanzania',
    status: true,
    description:
      '\n' +
      '\n' +
      'A visit to a Maasai village in Tanzania offers visitors a unique cultural experience. The Maasai are a semi-nomadic ethnic group living mainly in northern Tanzania and southern Kenya. Their distinct culture is characterized by colorful clothing, beaded jewelry and a pastoral lifestyle.\n' +
      '\n' +
      'When visiting a Maasai village, visitors have the opportunity to meet members of the tribe and learn more about their traditional way of life. They can observe traditional dwellings called “bomas”, built from branches, mud and cow dung. The daily activities of the Maasai, such as cattle-raising, craft-making and traditional dance, are also presented.\n' +
      '\n' +
      'The Maasai are renowned for their warm and welcoming hospitality. Visitors can sample traditional Maasai cuisine, which typically includes fermented cow’s milk, beef and corn porridge.\n' +
      '\n' +
  ...
  {
    id: 8,
    title: 'Market visit in Arusha (Spice, Fruit and Vegetable Market)',
    status: true,
    description:
  ...
  },
  {
    ...
    description:
      '\n' +
      '\n' +
      'A day in a hot-air balloon in Arusha is an extraordinary experience that allows you to discover the breathtaking beauty of the region in a unique way. You’ll soar gently over Tanzania’s vast plains and spectacular landscapes.\n' +
      '\n' +
  ...
  {
    id: 11,
    title: 'The Town of Arusha',
    status: true,
    description:
      '\n' +
      '\n' +
      'Arusha, the pearl of Tanzania, stands proudly with its emblematic clock tower, like a sentinel of time. This majestic structure, adorned with elegant architectural details, dominates the city and reminds us of the importance of each passing moment.\n' +
      '\n' +
      'Immerse yourself in the history and culture of the region by visiting the local history museum, where fascinating treasures await you.\n' +
      '\n' +
  ...
  {
    id: 12,
    title: 'The Ndutu region',
    status: true,
    description:
      '\n' +
      '\n' +
      'The Ndutu region is located in northern Tanzania, close to the Serengeti National Park. It’s an area renowned for its natural beauty and abundant wildlife. The vast Ndutu plains offer spectacular scenery, with stretches of golden grass and scattered acacias.\n' +
      '\n' +
      'The Ndutu region is famous for its annual migration of wildebeest and zebra, who move en masse in search of fresh pasture. It’s an incredible sight to see, with thousands of animals in motion.\n' +
      '\n' +
      'Ndutu is also renowned for its all-terrain vehicle safaris, which allow visitors to get up close and personal with wild animals. You can see lions, leopards, elephants and many other species.\n' +
      '\n' +
      'The Ndutu region is also home to a wide variety of birds, particularly during the rainy season, when the lakes and marshes fill with water. It’s a paradise for birdwatchers.\n' +
      '\n' +
