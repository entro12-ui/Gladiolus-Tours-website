...
const galleryImages: GalleryImage[] = [
  {
    id: 1,
    src: assetUrl("/hero/hero-00.webp"),
    alt: "Sunrise balloons drifting above the Serengeti plains",
    category: "Landscapes",
    location: "Serengeti National Park",
  },
  {
    id: 2,
    src: assetUrl("/hero/hero-01.webp"),
    alt: "Lion pride surveying the short grass plains",
    category: "Wildlife",
  ...
  },
  {
    ...
    alt: "Guests sharing sundowners atop the Ngorongoro rim",
    category: "Experiences",
    location: "Ngorongoro Conservation Area",
  },
  {
    id: 4,
    src: assetUrl("/hero/hero-03.webp"),
    alt: "Elephants crossing a floodplain at dusk",
    category: "Wildlife",
    location: "Tarangire National Park",
  },
  {
    id: 5,
    src: assetUrl("/hero/hero-04.webp"),
    alt: "Private dinner staged beneath acacia trees",
    category: "Experiences",
    location: "Serengeti Plains",
  },
  {
    id: 6,
    src: assetUrl("/hero/hero-05.webp"),
    alt: "Walking safari with an armed ranger and guide",
    category: "Activities",
    location: "Ruaha National Park",
  },
  {
    id: 7,
    src: assetUrl("/hero/hero-06.webp"),
    alt: "Cheetah sprint frozen mid-stride",
    category: "Wildlife",
    location: "Eastern Serengeti",
  },
  {
    id: 8,
    src: assetUrl("/hero/hero-07.webp"),
    alt: "Couple boarding a private charter on a dirt strip",
    category: "Logistics",
  ...
  },
  {
    ...
    alt: "Wildebeest cutting across the Mara River",
    category: "Wildlife",
    location: "Northern Serengeti",
  },
  {
    id: 10,
    src: assetUrl("/ngorongoro-crater-landscape-elephants.jpg"),
    alt: "Elephants grazing on the crater floor",
    category: "Landscapes",
  ...
  },
  {
    ...
    alt: "Gladiolus concierge team crafting itineraries",
    category: "People",
    location: "Arusha Studio",
  },
  {
    id: 12,
    src: assetUrl("/masai-mara-wildlife-safari-sunset.jpg"),
    alt: "Pastel sunset over the savanna",
    category: "Landscapes",
